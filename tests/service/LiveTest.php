...
use Codenom\Schemas\Drafter\Handlers\DatabaseHandler;
use Codenom\Schemas\Drafter\Handlers\DirectoryHandler;
use Codenom\Schemas\Drafter\Handlers\ModelHandler;
...
class LiveTest extends Tests\Support\DatabaseTestCase
{
	...
	public function testDatabaseToCache()
	{
		...
		$cacheHandler    = new \Codenom\Schemas\Archiver\Handlers\CacheHandler($this->config, $cache);
	...
	public function testGetReturnsSchemaWithReader()
	{
		...
		$this->assertInstanceOf('\Codenom\Schemas\Reader\BaseReader', $schema->tables);
	}
