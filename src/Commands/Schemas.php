...
namespace Codenom\Schemas\Commands;
...
class Schemas extends BaseCommand
{
    ...
    public function run(array $params)
    {
        ...
        $schemas = new \Codenom\Schemas\Schemas($config, null);
        ...
        if ($params['-print'] ?? CLI::getOption('print')) {
            $archivers = '\Codenom\Schemas\Archiver\Handlers\CliHandler';
    ...
    protected function getHandler(string $type, string $name): string
    {
        ...
        $class = '\Codenom\Schemas\\' . $type . '\Handlers\\' . ucfirst($name) . 'Handler';
...
/** End of src/Commands/Schemas.php */
